...
namespace LumenRT 
{
	...
	private:
		void DrawAssetTile(LRT_GUID guid, const char* title);
		void DrawSceneTile(LRT_GUID guid, const char* title);
		void DrawGenericTile(LRT_GUID guid, const char* title, const char* icon, const char* dndPayloadType);
		void DrawTileInfo();
		...
		LRT_GUID m_SelectedTileGuid = LRT_GUID::INVALID;
