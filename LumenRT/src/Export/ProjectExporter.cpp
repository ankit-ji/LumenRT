...
namespace LumenRT
{
    ...
    bool ExportProject(
		...
		// ensure projectFolderPath contains .lrtproj file
        ...
        try {
            ...
            // Copy source folder (containing .lrtproj and assets)
			...
			std::filesystem::rename(
				exportProjectFolderPath / "LumenRTRuntime.exe", // hardcoded string (not ideal)
				exportProjectFolderPath / (projectName + ".exe")
			);
			#else
			std::filesystem::rename(
				exportProjectFolderPath / "LumenRTRuntime",
