...
namespace LumenRT
{
	...
	#define SCENE_FILE_EXTENSION ".lrtscn"
	...
	public:
		...
		EntityHandle CreateEntityWithGuid(LRT_GUID guid, const std::string& name);
	...
	/// Saves scene data to 'scenepath' (full path with filename and extension, e.g. "c:/dev/scene.lrtscn").
